...
```xml
    <bean name="helloExporter"
        ...
        <property name="serviceInterface" value="com.huifer.source.httpinvoker.IHttpInvokerService">
        </property>
    </bean>
    <bean id="helloService" class="com.huifer.source.httpinvoker.IHttpInvokerServiceImpl"/>
```
### 客户端
